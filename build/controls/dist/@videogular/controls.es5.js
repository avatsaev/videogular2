...
var VgControls = (function () {
    ...
    VgControls.prototype.ngOnInit = function () {
        var _this = this;
        var mouseMove = Observable$1.fromEvent(this.API.videogularElement, 'mousemove');
        this.subscriptions.push(mouseMove.subscribe(this.show.bind(this)));
        var touchStart = Observable$1.fromEvent(this.API.videogularElement, 'touchstart');
...
//# sourceMappingURL=controls.es5.js.map
