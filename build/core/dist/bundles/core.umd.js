(function (global, factory) {
	...
	(factory((global.videogular = global.videogular || {}, global.videogular.core = {}),global.ng.core,global.ng.common,global.Rx,global.Rx));
...
exports.VgStates = (function () {
    function VgStates() {
    }
    return VgStates;
}());
exports.VgStates.VG_ENDED = 'ended';
exports.VgStates.VG_PAUSED = 'paused';
exports.VgStates.VG_PLAYING = 'playing';
exports.VgStates.VG_LOADING = 'waiting';
exports.VgStates = __decorate$3([
    core.Injectable()
], exports.VgStates);
    ...
    VgAPI.prototype.$$getAllProperties = function (property) {
        ...
        switch (nMedias) {
            case 0:
                ...
                switch (property) {
                    case 'state':
                        result = exports.VgStates.VG_PAUSED;
                        break;
                    case 'playbackRate':
                    case 'volume':
                        result = 1;
...
exports.VgFullscreenAPI = (function () {
    ...
    VgFullscreenAPI.prototype.init = function (elem, medias) {
        ...
        if (exports.VgUtils.isiOSDevice()) {
    ...
    VgFullscreenAPI.prototype.request = function (elem) {
        ...
        if (this.isAvailable && this.nativeFullscreen) {
            ...
            if (exports.VgUtils.isMobileDevice()) {
                // We should make fullscreen the video object if it doesn't have native fullscreen support
                // Fallback! We can't set vg-player on fullscreen, only video/audio objects
                if ((!this.polyfill.enabled && elem === this.videogularElement) || exports.VgUtils.isiOSDevice()) {
...
exports.VgFullscreenAPI = __decorate$4([
    core.Injectable(),
    __metadata$2("design:paramtypes", [])
], exports.VgFullscreenAPI);
...
exports.VgEvents = (function () {
    function VgEvents() {
    }
    return VgEvents;
}());
exports.VgEvents.VG_ABORT = 'abort';
exports.VgEvents.VG_CAN_PLAY = 'canplay';
exports.VgEvents.VG_CAN_PLAY_THROUGH = 'canplaythrough';
exports.VgEvents.VG_DURATION_CHANGE = 'durationchange';
exports.VgEvents.VG_EMPTIED = 'emptied';
exports.VgEvents.VG_ENCRYPTED = 'encrypted';
exports.VgEvents.VG_ENDED = 'ended';
exports.VgEvents.VG_ERROR = 'error';
exports.VgEvents.VG_LOADED_DATA = 'loadeddata';
exports.VgEvents.VG_LOADED_METADATA = 'loadedmetadata';
exports.VgEvents.VG_LOAD_START = 'loadstart';
exports.VgEvents.VG_PAUSE = 'pause';
exports.VgEvents.VG_PLAY = 'play';
exports.VgEvents.VG_PLAYING = 'playing';
exports.VgEvents.VG_PROGRESS = 'progress';
exports.VgEvents.VG_RATE_CHANGE = 'ratechange';
exports.VgEvents.VG_SEEK = 'seek';
exports.VgEvents.VG_SEEKED = 'seeked';
exports.VgEvents.VG_SEEKING = 'seeking';
exports.VgEvents.VG_STALLED = 'stalled';
exports.VgEvents.VG_SUSPEND = 'suspend';
exports.VgEvents.VG_TIME_UPDATE = 'timeupdate';
exports.VgEvents.VG_VOLUME_CHANGE = 'volumechange';
exports.VgEvents.VG_WAITING = 'waiting';
exports.VgEvents.VG_LOAD = 'load';
exports.VgEvents.VG_ENTER = 'enter';
exports.VgEvents.VG_EXIT = 'exit';
exports.VgEvents.VG_START_ADS = 'startads';
exports.VgEvents.VG_END_ADS = 'endads';
exports.VgEvents = __decorate$7([
    core.Injectable()
], exports.VgEvents);
...
exports.VgMedia = (function () {
    function VgMedia(api, ref) {
        this.api = api;
        this.ref = ref;
        this.state = exports.VgStates.VG_PAUSED;
    ...
    VgMedia.prototype.ngOnInit = function () {
        ...
        this.subscriptions = {
            // Native events
            abort: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_ABORT),
            canPlay: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_CAN_PLAY),
            canPlayThrough: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_CAN_PLAY_THROUGH),
            durationChange: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_DURATION_CHANGE),
            emptied: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_EMPTIED),
            encrypted: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_ENCRYPTED),
            ended: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_ENDED),
            error: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_ERROR),
            loadedData: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_LOADED_DATA),
            loadedMetadata: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_LOADED_METADATA),
            loadStart: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_LOAD_START),
            pause: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_PAUSE),
            play: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_PLAY),
            playing: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_PLAYING),
            progress: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_PROGRESS),
            rateChange: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_RATE_CHANGE),
            seeked: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_SEEKED),
            seeking: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_SEEKING),
            stalled: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_STALLED),
            suspend: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_SUSPEND),
            timeUpdate: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_TIME_UPDATE),
            volumeChange: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_VOLUME_CHANGE),
            waiting: Observable.Observable.fromEvent(this.elem, exports.VgEvents.VG_WAITING),
            // Advertisement only events
            startAds: Observable.Observable.fromEvent(window, exports.VgEvents.VG_START_ADS),
            endAds: Observable.Observable.fromEvent(window, exports.VgEvents.VG_END_ADS),
            ...
            for (var media in _this.api.medias) {
                if (_this.api.medias[media] !== _this) {
                    ...
                    if (diff < -0.3 || diff > 0.3) {
                        _this.playAtferSync = (_this.state === exports.VgStates.VG_PLAYING);
                        _this.pause();
    ...
    VgMedia.prototype.play = function () {
        ...
        if (this.playPromise || (this.state !== exports.VgStates.VG_PAUSED && this.state !== exports.VgStates.VG_ENDED)) {
            return;
        }
    ...
    VgMedia.prototype.onComplete = function (event) {
        ...
        this.state = exports.VgStates.VG_ENDED;
        this.ref.detectChanges();
    };
    VgMedia.prototype.onStartPlaying = function (event) {
        this.state = exports.VgStates.VG_PLAYING;
        this.ref.detectChanges();
    };
...
], exports.VgMedia.prototype, "vgMedia", void 0);
__decorate$6([
    core.Input(),
    __metadata$3("design:type", Boolean)
], exports.VgMedia.prototype, "vgMaster", void 0);
exports.VgMedia = __decorate$6([
    core.Directive({
        selector: '[vgMedia]'
    }),
    __metadata$3("design:paramtypes", [exports.VgAPI, core.ChangeDetectorRef])
], exports.VgMedia);
...
exports.VgControlsHidden = (function () {
...
exports.VgControlsHidden = __decorate$8([
    core.Injectable(),
...
exports.VgPlayer = (function () {
    ...
    VgPlayer.prototype.onChangeFullscreen = function (fsState) {
        if (!this.fsAPI.nativeFullscreen) {
            ...
            this.zIndex = fsState ? exports.VgUtils.getZIndex().toString() : 'auto';
        }
        else {
...
], exports.VgPlayer.prototype, "isFullscreen", void 0);
__decorate$1([
    core.HostBinding('class.native-fullscreen'),
    __metadata("design:type", Boolean)
], exports.VgPlayer.prototype, "isNativeFullscreen", void 0);
__decorate$1([
    core.HostBinding('class.controls-hidden'),
    __metadata("design:type", Boolean)
], exports.VgPlayer.prototype, "areControlsHidden", void 0);
__decorate$1([
    core.HostBinding('style.z-index'),
    __metadata("design:type", String)
], exports.VgPlayer.prototype, "zIndex", void 0);
__decorate$1([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.VgPlayer.prototype, "onPlayerReady", void 0);
__decorate$1([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.VgPlayer.prototype, "onMediaReady", void 0);
__decorate$1([
    core.ContentChildren(exports.VgMedia),
    __metadata("design:type", core.QueryList)
], exports.VgPlayer.prototype, "medias", void 0);
exports.VgPlayer = __decorate$1([
    core.Component({
        selector: 'vg-player',
        encapsulation: core.ViewEncapsulation.None,
        template: "\n      <ng-content></ng-content>\n    ",
        styles: ["\n      vg-player {\n        font-family: 'videogular';\n        position: relative;\n        display: flex;\n        width: 100%;\n        height: 100%;\n        overflow: hidden;\n        background-color: black; }\n        vg-player.fullscreen {\n          position: fixed;\n          left: 0;\n          top: 0; }\n        vg-player.native-fullscreen.controls-hidden {\n          cursor: none; }\n    "],
        providers: [exports.VgAPI, exports.VgFullscreenAPI, exports.VgControlsHidden]
    }),
    __metadata("design:paramtypes", [core.ElementRef, exports.VgAPI, exports.VgFullscreenAPI, exports.VgControlsHidden])
], exports.VgPlayer);
...
exports.VgCuePoints = (function () {
    ...
    VgCuePoints.prototype.ngOnInit = function () {
        var onLoad = Observable.Observable.fromEvent(this.ref.nativeElement, exports.VgEvents.VG_LOAD);
    ...
    VgCuePoints.prototype.updateCuePoints = function (cues) {
        ...
        for (var i = 0, l = cues.length; i < l; i++) {
            var onEnter = Observable.Observable.fromEvent(cues[i], exports.VgEvents.VG_ENTER);
            this.cuesSubscriptions.push(onEnter.subscribe(this.onEnter.bind(this)));
            var onExit = Observable.Observable.fromEvent(cues[i], exports.VgEvents.VG_EXIT);
...
], exports.VgCuePoints.prototype, "onEnterCuePoint", void 0);
__decorate$9([
    core.Output('onUpdateCuePoint'),
    __metadata$5("design:type", core.EventEmitter)
], exports.VgCuePoints.prototype, "onUpdateCuePoint", void 0);
__decorate$9([
    core.Output('onExitCuePoint'),
    __metadata$5("design:type", core.EventEmitter)
], exports.VgCuePoints.prototype, "onExitCuePoint", void 0);
__decorate$9([
    core.Output('onCompleteCuePoint'),
    __metadata$5("design:type", core.EventEmitter)
], exports.VgCuePoints.prototype, "onCompleteCuePoint", void 0);
exports.VgCuePoints = __decorate$9([
    core.Directive({
...
var CORE_DECLARATIONS = [
    exports.VgPlayer, exports.VgMedia, exports.VgCuePoints
];
exports.VgCoreModule = (function () {
    function VgCoreModule() {
    }
    return VgCoreModule;
}());
exports.VgCoreModule = __decorate([
    core.NgModule({
        imports: [common.CommonModule],
        declarations: [CORE_DECLARATIONS],
        exports: [CORE_DECLARATIONS],
        providers: [exports.VgAPI, exports.VgFullscreenAPI, exports.VgUtils, exports.VgControlsHidden]
    })
